const overviewsVzkazy = [
  {//článek - Pane Bože jenom to ne - říjen 2023
    ...
    a dokonalost není zárukou štěstí <br>
    A láska bez podmínek souvisí se sebevědomím<br>
    A to je štěstí <br>
    A pokud Vás nikdo takhle nemiluje, <br>
    musíte věřit, že takhle Vás miluje Bůh.<br>
    ...
    Z Prahy ta cesta trvá něco málo přes dvě hodiny`,
    readMore: 'Číst dále',
    ...
    title: '',
    text: `O Santiago<br>
    Říkala ta postarší servírka s nádhernejma <br>
    nohama a hladila tě po vláskách. <br>
    A mě dojímalo, jak je na tebe hodná… <br>
    a strašně jsem toužila po takových nohách. <br>
